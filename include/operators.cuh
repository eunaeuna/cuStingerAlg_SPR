...
template <cusSubKernelVertex cusSK>
static void allVinA_TraverseVertices(cuStinger& custing,void* metadata, vertexQueue& vQueueSrc, length_t len ){

	vertexId_t* verArray = vQueueSrc.getQueueAtCurr();
	//length_t len = vQueueSrc.getActiveQueueSize();
